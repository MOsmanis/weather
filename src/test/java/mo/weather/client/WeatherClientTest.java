...
class WeatherClientTest {
    ...
    void setUp() {
        ...
        weatherClient = spy(new WeatherClient(responseMapper, "https://example.com/weather/%1$s/%2$s"));
    ...
    void testGetResponse_SuccessfulResponse() {
        ...
        var expectedResponse = new WeatherDTO(123.111, 321.111,30.5, "Clear Sky", "https://example.com/weather/10.0/-20.0");
        String jsonResponse = "jsonResponse";
        when(restTemplate.getForEntity("https://example.com/weather/10.0/-20.0", String.class)).thenReturn(responseEntity);
        ...
        inOrder.verify(restTemplate).getForEntity("https://example.com/weather/10.0/-20.0", String.class);
    ...
    void testGetResponse_ExceptionOccurred() {
        // Given
        var locationDTO = new LocationDTO(10.0, -20.0, "https://example.com/location/1.1.1.1");
        when(restTemplate.getForEntity("https://example.com/weather/10.0/-20.0", String.class))
    ...
    void testGetRequestUrl() {
        ...
        // Then
        assertEquals("https://example.com/weather/10.0/-20.0", requestUrl);
    }
}